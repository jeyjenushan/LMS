...
const Footer = () => {
  return (
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-whitte/30
      "
      >
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/80">
            ...
            velit quasi tenetur itaque necessitatibus. Vel laboriosam quas
            necessitatibus commodi minima vitae neque? Rerum dignissimos
            incidunt iusto repellendus doloribus, dolor facilis!
          </p>
        </div>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-white/60">
        Copyright 2025 @ JeyaJenu.All Right Reserved.
      </p>
    </footer>
  );
};
