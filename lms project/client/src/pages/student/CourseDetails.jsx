                          ...
                          <div className="flex gap-2">
                            {lecture.preview && (
                              <p
                                onClick={() =>
                                  setPlayerData({
                                    videoId: getYouTubeId(lecture.videoUrl),
                                    title: lecture.title,
                                  })
                                }
          ...
          <div className="p-5">
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calculateTotalNumberLectures(courseData)} lessons</p>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Quizzed to test your knowledge.</li>
